# CB.controller 'SolarSystemsCtrl', ($scope, SolarSystemFinder, $timeout, filterConstraints, $modal, Corporations, Regions) ->
#   $scope.solarSystems = []
#   $scope.loading      = true
#   $scope.fields       = []
#   $scope.filters      = SolarSystemFinder.filter()
#   order               = SolarSystemFinder.order()
#
#   fetchSolarSystems = ->
#     $scope.loading = true
#     SolarSystemFinder.fetch $scope.filters, order, (solarSystems) ->
